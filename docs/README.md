...
| Lane | Purpose | Where |
|------|---------|--------|
| **Design** | What was built and why | [`epic3/`](epic3/README.md), [`epic4/`](epic4/README.md) design chapters, [ACT report](ACT_EVAL_REPORT_100K.md). Long-form also on **BookStack**; [Epic 3](EPIC3_SIMULATION_TRAINING_PIPELINE.md) / [Epic 4](EPIC4_VR_INTEGRATION.md) GitHub hubs keep BookStack→repo links working. |
...
| [Epic 3 hub](EPIC3_SIMULATION_TRAINING_PIPELINE.md) / [Epic 4 hub](EPIC4_VR_INTEGRATION.md) | Thin GitHub link hubs (preserve BookStack→repo URLs); **not** a second full design copy — long-form is on BookStack; chapters under `epic3/` / `epic4/` |
